        	...
        	<div class="col-md-12">
            	<div class="box">
                	<div class="box-header with-border">
                    	<div class="box-title">
                        	<a href="<?php echo base_url('admin/searchservice/faqs_list') ;?>">
                            	<button class="btn btn-sm btn-success"><i class="fa fa-plus"></i>FAQS LIST</button>
                        	</a>
                        </div>
                        <!--<div class="pull-right"><a href="" class="btn btn-sm btn-primary"> STAFF LIST </a></div>-->
                    </div>
                    <div class="box-body">
						<form action="<?php echo base_url('admin/searchservice/insert_faqs');?>" enctype="multipart/form-data" method="POST">
                        	<div class="row form-group">
                                ...
                                <div class="col-sm-12 col-md-6">                                
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            <?php echo form_textarea(array('name' => 'answer', 'id' => 'answer', 'class' => 'form-control')); ?>
