                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="<?php echo base_url('/meeting/5'); ?>" class="dropdown-item">Hardware & Networking</a>
                                 <a href="<?php echo base_url('/meeting/6'); ?>" class="dropdown-item">Lay Out Designing & Interior</a>
                            </div>
                        </div>
