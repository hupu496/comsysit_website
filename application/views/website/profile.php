...
/*      border-radius: 50%; */
      padding: 20px; 
      display: inline-block; /* Keeps icon in shape */
    }
  </style>
         <!-- Header Start -->
         <div class="container-fluid bg-breadcrumb">
            ...
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Profile Us</h1>
        ...
        <div class="container-fluid feature overflow-hidden py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    ...
                    <h1 class="display-5 mb-4">Why Choose ComSys IT</h1>
                ...
                <div class="row g-4 justify-content-center text-center mb-5">
                    <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="text-center p-4">
                            <div class="d-inline-block rounded bg-light p-4 mb-4"><i class="fas fa-rocket fa-5x text-secondary enthusiastic-team-icon"></i></div>
                            <div class="feature-content">
                                <a href="#" class="h4">Fast and Innovative<i class="fa fa-long-arrow-alt-right"></i></a>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="text-center p-4">
                            <div class="d-inline-block rounded bg-light p-4 mb-4"><i class="fas fa-users fa-5x text-secondary enthusiastic-team-icon"></i></div>
                            <div class="feature-content">
                                <a href="#" class="h4">Enthusiastic Team<i class="fa fa-long-arrow-alt-right"></i></a>
                                <p class="mt-4 mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.consectetur adipisicing elit
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="text-center rounded p-4">
                            <div class="d-inline-block rounded bg-light p-4 mb-4"><i class="fas fa-smile fa-5x text-secondary enthusiastic-team-icon"></i></div>
                            <div class="feature-content">
                                <a href="#" class="h4">Client Satisfaction <i class="fa fa-long-arrow-alt-right"></i></a>
                                <p class="mt-4 mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.consectetur adipisicing elit
                                </p>
                            </div>
                        </div>
                ...
                <div class="row g-5 pt-5" style="margin-top: 6rem;">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.1s">
                        ...
                        <h1 class="display-5 mb-4">Our Work Process</h1>
                        <p class="mb-4"><b>10+ Years of Excellence</b>,Deriving goal-oriented results and satisfying client's requirement is the foremost approach we consider about.
                        <b>Fast and Innovative</b>We provide innovative solutions and undertakes a quality approach to provide you with result-oriented business solutions on time.
                        <b>Direct Contact with Expertise for Project Discussion</b>
                        In order to avoid confusion and often queries amidst project designing phase
                        <b>Choose the Engagement Timeline for Your Project</b>
                        With proper planning and a strategic blueprint, we ensure the seamless allocation of the right development team to execute all consultations provided by our experts.
                        <b>Project Delivery on Time</b>
                        Our software development team is well versed in executing projects prior to the deadline. Therefore, you can expect 100% timely delivery of your project fulfilling all requirements.
                        </p>
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex">
