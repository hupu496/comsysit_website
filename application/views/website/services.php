                        ...
                        <div class="service-item text-center rounded p-4">
                            ...
                            <div class="service-content">
                                ...
                                <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit.consectetur adipisicing elit
                                 ...
                                 <a href="#" class="btn btn-light rounded-pill text-primary py-2 px-4" data-bs-toggle="modal" data-bs-target="#exampleModal">Module</a>
                                <a href="#" class="btn btn-light rounded-pill text-primary py-2 px-4" data-bs-toggle="modal" data-bs-target="#exampleModalorder">Order</a>
                            </div>
                        </div>
                    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">vistor gatespass</h5>
