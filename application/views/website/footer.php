                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="tel:+919470506166" class="mb-3"><i class="fas fa-print me-2"></i> +919470506166 </a>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-white"><a href="#" style="text-decoration:none; color:white;"><i class="fas fa-copyright text-light me-2"></i>ComSysIT</a>, All right reserved.</span>
                    </div>
