                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="https://erp.coppertec.in/" target="_blank">Employee Login</a>
                             <a href="https://erp.coppertec.in/" target="_blank"><img src="<?php echo base_url('assets/images/file.jpg'); ?>" alt="" style="width:90px; border-radius:100px;"></a>
                             ...
                             <?php  $services = $this->db->get_where('services',array('status'=>1))->result_array();
                                if(!empty($services)){
                                    foreach ($services as $key => $value) {  ?>
                                     <a href="<?php echo base_url('homeservice/service/'.$value['id']); ?>"><?php echo $value['name']; ?></a>
                           <?php         }
                                }  ?>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="tel:+06585-227977" class="mb-3"><i class="fas fa-print me-2"></i> +06585-227977 </a>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-white"><a href="#" style="text-decoration:none; color:white;"><img src="<?php echo base_url('assets/images/file.jpg'); ?>" alt="" style="border-radius:100px; width:30px;">&nbsp;ComSysIT</a>, All right reserved.</span>
                    </div>
